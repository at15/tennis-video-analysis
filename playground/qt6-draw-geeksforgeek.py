...
from PyQt6.QtGui import QColor, QPainter, QPen, QAction, QImage
from PyQt6.QtWidgets import QApplication, QMainWindow, QColorDialog, QFileDialog

# From https://www.geeksforgeeks.org/pyqt5-create-paint-application/ and updated to PyQt6
class Window(QMainWindow):
    ...
    def mouseMoveEvent(self, event):
        ...
        if (event.buttons() == Qt.MouseButton.LeftButton) and self.drawing:
            print("Left Mouse Button Moving") 
